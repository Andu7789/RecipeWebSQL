...
app.post('/api/POSTFindSearchItemsThisWeek', (request, response) => {

  let searchString = request.body.labelsArray; // Get search string from request
  console.log('POSTFindSearchItemsThisWeek:', searchString);
  if (!searchString) {
...
app.get("/api/getMissedAPI", (req, res) => {
  db2
    .find({ MissedTrade: "missedTrade" })
    .sort({ date: -1 })
    .exec((err, items) => {
      if (err) {
        console.error("getMissedAPI:", err);
        res.status(500).json({ error: "Internal Server Error" });
      } else {
        console.log("getMissedAPI: Success");
        res.json(items);
      }
    });
});

app.post("/api/DXYUpdateEntryCommentsAPI", (request, response) => {
  const requestData = request.body;
  console.log("Received trade number to update: DXYExit", requestData.tradeNumber);
  const newTradeData = {
    DXYEntryComment: requestData.DXYEntryComment,
  ...
  db2.update(
    ...
    (err, numReplaced) => {
      if (err) {
        ...
        console.log("Trade data updated successfully. Updated:DXYEntryComment", numReplaced);
        response.json("Updated:DXYEntryComment");
      }
    }
  );
});

app.post("/api/ALL4UpdateEntryCommentsAPI", (request, response) => {
  const requestData = request.body;
  console.log("Received trade number to update: ALL4Exit", requestData.tradeNumber);
  const newTradeData = {
    ALL4EntryComment: requestData.ALL4EntryComment,
  ...
  db2.update(
    ...
    (err, numReplaced) => {
      if (err) {
        ...
        console.log("Trade data updated successfully. Updated:ALL4EntryComment", numReplaced);
        response.json("Updated:ALL4EntryComment");
      }
    }
  );
});

app.post("/api/GJUpdateEntryCommentsAPI", (request, response) => {
  const requestData = request.body;
  console.log("Received trade number to update: GJExit", requestData.tradeNumber);
  const newTradeData = {
    GJEntryComment: requestData.GJEntryComment,
  ...
  db2.update(
    ...
    (err, numReplaced) => {
      if (err) {
        ...
        console.log("Trade data updated successfully. Updated:GJEntryComment", numReplaced);
        response.json("Updated:GJEntryComment");
      }
    }
  );
});

app.post("/api/PairUpdateEntryCommentsAPI", (request, response) => {
  const requestData = request.body;
  console.log("Received trade number to update: PairExit", requestData.tradeNumber);
  const newTradeData = {
    PairEntryComment: requestData.PairEntryComment,
  ...
  db2.update(
    ...
    (err, numReplaced) => {
      if (err) {
        ...
        console.log("Trade data updated successfully. Updated:PairEntryComment", numReplaced);
        response.json("Updated:PairEntryComment");
      }
    }
  );
});
...
app.post("/api/AUUpdateEntryCommentsAPI", (request, response) => {
  const requestData = request.body;
  console.log("Received trade number to update: AUExit", requestData.tradeNumber);
  const newTradeData = {
    AUEntryComment: requestData.AUEntryComment,
  ...
  db2.update(
    ...
    (err, numReplaced) => {
      if (err) {
        ...
        console.log("Trade data updated successfully. Updated:AUEntryComment", numReplaced);
        response.json("Updated:AUEntryComment");
      }
    }
  );
});

app.post("/api/EUUpdateEntryCommentsAPI", (request, response) => {
  const requestData = request.body;
  console.log("Received trade number to update: EUExit", requestData.tradeNumber);
  const newTradeData = {
    EUEntryComment: requestData.EUEntryComment,
  ...
  db2.update(
    ...
    (err, numReplaced) => {
      if (err) {
        ...
        console.log("Trade data updated successfully. Updated:EUEntryComment", numReplaced);
        response.json("Updated:EUEntryComment");
      }
    }
  );
});

app.post("/api/GBUpdateEntryCommentsAPI", (request, response) => {
  const requestData = request.body;
  console.log("Received trade number to update: GBExit", requestData.tradeNumber);
  const newTradeData = {
    GBEntryComment: requestData.GBEntryComment,
  ...
  db2.update(
    ...
    (err, numReplaced) => {
      if (err) {
        ...
        console.log("Trade data updated successfully. Updated:GBEntryComment", numReplaced);
        response.json("Updated:GBEntryComment");
      }
    }
  );
});

app.post("/api/NZUpdateEntryCommentsAPI", (request, response) => {
  const requestData = request.body;
  console.log("Received trade number to update: NZExit", requestData.tradeNumber);
  const newTradeData = {
    NZEntryComment: requestData.NZEntryComment,
  ...
  db2.update(
    ...
    (err, numReplaced) => {
      if (err) {
        ...
        console.log("Trade data updated successfully. Updated:NZEntryComment", numReplaced);
        response.json("Updated:NZEntryComment");
      }
    }
  );
});
...
app.post("/api/DXYUpdateEntryCommentsAPI", (request, response) => {
  const requestData = request.body;
  console.log("Received trade number to update: DXY", requestData.tradeNumber);
  const newTradeData = {
    DXYComment: requestData.DXYComment,
  };
  console.log({newTradeData});
  db2.update(
    ...
    (err, numReplaced) => {
      if (err) {
        ...
        console.log("Trade data updated successfully. Updated:DXYComment", numReplaced);
        response.json("Updated:DXYComment");
      }
    }
  );
});